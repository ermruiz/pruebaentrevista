		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prueba",
									"targetURL": "#sapbtppruebaentrevista-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtppruebaentrevista-display": {
								"semanticObject": "sapbtppruebaentrevista",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.pruebaentrevista",
									"url": sap.ui.require.toUrl("sap/btp/pruebaentrevista")
								}
							}
						}
					}
